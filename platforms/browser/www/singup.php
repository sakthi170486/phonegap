...
<body>
    <div class="app">
       <div class="wrap-login100">
		<form class="login100-form validate-form" action="signup_data.php" method="POST">
			...
			<div class="wrap-input100 validate-input" data-validate="Enter Company Name">
				<input class="input100" type="text" name="comp_name" placeholder="Company Name">
			...
			<div class="wrap-input100 validate-input" data-validate="Enter Mobile No">
				<input class="input100" type="number" name="altmobile" placeholder="Alternative Number">
				<span class="focus-input100" data-placeholder=""></span>
			</div>
			...
			<div class="container-login100-form-btn">
				<input type="submit" style="background-color:white;" class="login100-form-btn" value="Sign Up">
				</div>
			</form></div>
    </div>
